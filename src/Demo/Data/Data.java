...
//	public static final int WINDOW_POSITION_X=0;
	...
	//原子弹发射按钮
	public static int ATOMIC_BOMB_BUTTON_WIDTH=MENU_BUTTON_WIDTH;
	public static int ATOMIC_BOMB_BUTTON_HEIGHT=ATOMIC_BOMB_BUTTON_WIDTH;
	public static int ATOMIC_BOMB_BUTTON_POSITION_X=0;
	public static int ATOMIC_BOMB_BUTTON_POSITION_Y=WINDOW_HEIGHT-ATOMIC_BOMB_BUTTON_HEIGHT;
	...
	public static final int MAIN_MENU_FRAME_BUTTON_POSITION_X=MAIN_MENU_FRAME_BUTTON_WIDTH/2;//按钮横坐标
	public static final int MAIN_MENU_FRAME_BUTTON_POSITION_START_Y=20;//最上面按钮纵坐标
	/**
	 * 对话框窗口
	 */
	...
	public static final int LASER_HARM=1;
